        ...
        if (hDC != NULL) {
            ...
            if (hMemDC != NULL) {
                ...
                if (hSecondDC != NULL) {
                    ...
                    TransparentBlt(hDC, rect.right / 2 - width / 2, rect.bottom / 2 - height / 2, width, height, hMemDC, 0, 0, width, height, RGB(255, 255, 255));
